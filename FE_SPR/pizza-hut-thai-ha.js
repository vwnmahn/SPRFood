...
const currentRestaurant = {
    id: 5,
    name: "Pizza Hut - Thái Hà",
    slug: "pizza-hut-thai-ha"
};
...
// ============================================
const menuData = [
    { id: 1, name: "Pizza hải sản", description: "Pizza tôm, mực, thanh cua", price: 159000, oldPrice: 189000, category: "main", popular: true, image: "🍕" },
    { id: 2, name: "Pizza bò", description: "Pizza thịt bò, phô mai", price: 139000, oldPrice: 169000, category: "main", popular: true, image: "🍕" },
    { id: 3, name: "Pizza thập cẩm", description: "Pizza nhiều loại topping", price: 179000, oldPrice: 209000, category: "main", popular: true, image: "🍕" },
    { id: 4, name: "Pepsi", description: "Pepsi lon", price: 20000, oldPrice: 30000, category: "drink", popular: true, image: "🥤" },
    { id: 5, name: "Cánh gà chiên", description: "Cánh gà chiên sốt cay", price: 69000, oldPrice: 89000, category: "snack", popular: true, image: "🍗" },
    { id: 6, name: "Khoai tây chiên", description: "Khoai tây chiên giòn", price: 39000, oldPrice: 49000, category: "snack", popular: true, image: "🍟" }
];
...
function renderMenu() {
    ...
    if (filtered.length === 0) {
        menuGrid.innerHTML = `<div style="grid-column:1/-1;text-align:center;padding:60px;"><i class="fas fa-pizza-slice" style="font-size:48px;color:var(--gray-text);margin-bottom:16px;"></i><p style="color:var(--gray-text);">Chưa có món ăn trong danh mục này</p></div>`;
        return;
    }
