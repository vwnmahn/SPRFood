...
// ============================================
const menuData = [
    { id: 1, name: "Phở bò tái", description: "Phở bò tái thăn, nước dùng đậm đà", price: 55000, oldPrice: 65000, category: "main", popular: true, image: "🍜" },
    { id: 2, name: "Phở bò chín", description: "Phở bò chín mềm, thơm ngon", price: 55000, oldPrice: 65000, category: "main", popular: true, image: "🍜" },
    { id: 3, name: "Phở tái nạm", description: "Phở tái nạm, thịt mềm ngọt", price: 60000, oldPrice: 70000, category: "main", popular: true, image: "🍜" },
    { id: 4, name: "Phở đặc biệt", description: "Phở đặc biệt tái, chín, nạm, gầu, gân", price: 80000, oldPrice: 95000, category: "main", popular: true, image: "🍱" },
    { id: 5, name: "Trà đá", description: "Trà đá mát lạnh", price: 5000, oldPrice: 10000, category: "drink", popular: true, image: "🍵" },
    { id: 6, name: "Sữa đậu nành", description: "Sữa đậu nành thơm mát", price: 15000, oldPrice: 20000, category: "drink", popular: true, image: "🥛" },
    { id: 7, name: "Quẩy", description: "Quẩy giòn, ăn kèm phở", price: 5000, oldPrice: 8000, category: "snack", popular: true, image: "🥖" },
    { id: 8, name: "Trứng lòng đào", description: "Trứng lòng đào, chấm với phở", price: 10000, oldPrice: 15000, category: "snack", popular: true, image: "🥚" }
];
...
function renderMenu() {
    ...
    if (filtered.length === 0) {
        menuGrid.innerHTML = `<div style="grid-column:1/-1;text-align:center;padding:60px;"><i class="fas fa-utensils" style="font-size:48px;color:var(--gray-text);margin-bottom:16px;"></i><p style="color:var(--gray-text);">Chưa có món ăn trong danh mục này</p></div>`;
        return;
    }
