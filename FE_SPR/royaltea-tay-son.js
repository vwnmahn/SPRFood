...
// ============================================
const menuData = [
    { id: 1, name: "Trà sữa Royal đặc biệt", description: "Trà sữa Royal với trân châu trắng", price: 35000, oldPrice: 45000, category: "main", popular: true, image: "🧋" },
    { id: 2, name: "Trà sữa matcha", description: "Trà sữa matcha Nhật Bản", price: 38000, oldPrice: 48000, category: "main", popular: true, image: "🍵" },
    { id: 3, name: "Trà sữa khoai môn", description: "Trà sữa khoai môn thơm béo", price: 37000, oldPrice: 47000, category: "main", popular: true, image: "🍠" },
    { id: 4, name: "Trà đào cam sả", description: "Trà đào cam sả mát lạnh", price: 32000, oldPrice: 42000, category: "drink", popular: true, image: "🍑" },
    { id: 5, name: "Trà chanh", description: "Trà chanh mát lạnh", price: 25000, oldPrice: 35000, category: "drink", popular: true, image: "🍋" },
    { id: 6, name: "Trân châu đen", description: "Trân châu đen dai giòn", price: 8000, oldPrice: 12000, category: "snack", popular: true, image: "⚫" },
    { id: 7, name: "Pudding", description: "Pudding thơm béo", price: 10000, oldPrice: 15000, category: "snack", popular: true, image: "🍮" }
];
...
function renderMenu() {
    ...
    if (filtered.length === 0) {
        menuGrid.innerHTML = `<div style="grid-column:1/-1;text-align:center;padding:60px;"><i class="fas fa-mug-hot" style="font-size:48px;color:var(--gray-text);margin-bottom:16px;"></i><p style="color:var(--gray-text);">Chưa có món ăn trong danh mục này</p></div>`;
        return;
    }
